...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2896350158400007399L;
   ...
   */
  public static guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder newBuilder() {
    return new guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder newBuilder(guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder other) {
    return new guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder(other);
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder newBuilder(guru.learningjournal.kafka.avroposgen.model.DeliveryAddress other) {
    return new guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(guru.learningjournal.kafka.avroposgen.model.DeliveryAddress other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.AddressLine)) {
        this.AddressLine = data().deepCopy(fields()[0].schema(), other.AddressLine);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder clearAddressLine() {
      AddressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder clearCity() {
      City = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder clearState() {
      State = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder clearPinCode() {
      PinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.DeliveryAddress.Builder clearContactNumber() {
      ContactNumber = null;
