...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3559138236407716987L;
   ...
   */
  public static guru.learningjournal.kafka.avroposgen.model.LineItem.Builder newBuilder() {
    return new guru.learningjournal.kafka.avroposgen.model.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static guru.learningjournal.kafka.avroposgen.model.LineItem.Builder newBuilder(guru.learningjournal.kafka.avroposgen.model.LineItem.Builder other) {
    return new guru.learningjournal.kafka.avroposgen.model.LineItem.Builder(other);
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static guru.learningjournal.kafka.avroposgen.model.LineItem.Builder newBuilder(guru.learningjournal.kafka.avroposgen.model.LineItem other) {
    return new guru.learningjournal.kafka.avroposgen.model.LineItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(guru.learningjournal.kafka.avroposgen.model.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(guru.learningjournal.kafka.avroposgen.model.LineItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.ItemCode)) {
        this.ItemCode = data().deepCopy(fields()[0].schema(), other.ItemCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder setItemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder clearItemCode() {
      ItemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder clearItemPrice() {
      ItemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder clearItemQty() {
      ItemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder setTotalValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.LineItem.Builder clearTotalValue() {
      TotalValue = null;
