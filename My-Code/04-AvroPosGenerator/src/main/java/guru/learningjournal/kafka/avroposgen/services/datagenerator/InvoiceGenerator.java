...
package guru.learningjournal.kafka.avroposgen.services.datagenerator;

import com.fasterxml.jackson.databind.ObjectMapper;
import guru.learningjournal.kafka.avroposgen.model.DeliveryAddress;
...
public class InvoiceGenerator {
    ...
    public PosInvoice getNextInvoice() {
        ...
        invoice.setCustomerType(invoice.getCustomerType().toString().trim());
