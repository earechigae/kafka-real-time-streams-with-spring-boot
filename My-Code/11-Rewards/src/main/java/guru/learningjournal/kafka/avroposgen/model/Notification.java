...
public class Notification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9042407349002849039L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Notification\",\"namespace\":\"guru.learningjournal.kafka.avroposgen.model\",\"fields\":[{\"name\":\"InvoiceNumber\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"CustomerCardNo\",\"type\":[\"null\",\"double\"]},{\"name\":\"TotalAmount\",\"type\":[\"null\",\"double\"]},{\"name\":\"EarnedLoyaltyPoints\",\"type\":[\"null\",\"double\"]},{\"name\":\"TotalLoyaltyPoints\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public Notification(java.lang.String InvoiceNumber, java.lang.Double CustomerCardNo, java.lang.Double TotalAmount, java.lang.Double EarnedLoyaltyPoints, java.lang.Double TotalLoyaltyPoints) {
   ...
   */
  public static guru.learningjournal.kafka.avroposgen.model.Notification.Builder newBuilder() {
    return new guru.learningjournal.kafka.avroposgen.model.Notification.Builder();
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static guru.learningjournal.kafka.avroposgen.model.Notification.Builder newBuilder(guru.learningjournal.kafka.avroposgen.model.Notification.Builder other) {
    return new guru.learningjournal.kafka.avroposgen.model.Notification.Builder(other);
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static guru.learningjournal.kafka.avroposgen.model.Notification.Builder newBuilder(guru.learningjournal.kafka.avroposgen.model.Notification other) {
    return new guru.learningjournal.kafka.avroposgen.model.Notification.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Notification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(guru.learningjournal.kafka.avroposgen.model.Notification.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(guru.learningjournal.kafka.avroposgen.model.Notification other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.InvoiceNumber)) {
        this.InvoiceNumber = data().deepCopy(fields()[0].schema(), other.InvoiceNumber);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder setInvoiceNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder clearInvoiceNumber() {
      InvoiceNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder setCustomerCardNo(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder clearCustomerCardNo() {
      CustomerCardNo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder setTotalAmount(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder clearTotalAmount() {
      TotalAmount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder setEarnedLoyaltyPoints(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder clearEarnedLoyaltyPoints() {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder setTotalLoyaltyPoints(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public guru.learningjournal.kafka.avroposgen.model.Notification.Builder clearTotalLoyaltyPoints() {
